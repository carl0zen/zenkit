...
ZenKit is a lightweight protocol layer for AI-assisted software building. It provides commands, schemas, hooks, checkpoints, and handoffs as plain files — no runtime, no daemon. It also exports a programmatic TypeScript API (`import { validate, createHandoff } from '@anthropic/zenkit'`).
